...
<body>
	...
	<section>
		...
		<div class="btnGroup">
			<div class="btn">
				<a href="#"><img src="${pageContext.request.contextPath}/resources/images/btn01.png" alt="홈페이지"></a>
				<p class="homepage btnTitle">미소 그리다</p>
				<p class="homepage btnTitle">홈페이지</p>
			</div>
			
			<div class="btn">
				<a href="#"><img src="${pageContext.request.contextPath}/resources/images/btn02.png" alt="특별함"></a>
				<p class="special btnTitle">미소 그리다</p>
				<p class="special btnTitle">특별함</p>
			</div>
			
			<div class="btn">
				<a href="#"><img src="${pageContext.request.contextPath}/resources/images/btn03.png" alt="치료이야기"></a>
				<p class="story btnTitle">미소 그리다</p>
				<p class="story btnTitle">치료이야기</p>
			</div>
			
			<div class="btn">
				<a href="#"><img src="${pageContext.request.contextPath}/resources/images/btn04.png" alt="둘러보기"></a>
